...
#define MPFR_FLAGS_ALL                                                         \
  (MPFR_FLAGS_UNDERFLOW | MPFR_FLAGS_OVERFLOW | MPFR_FLAGS_NAN |               \
   MPFR_FLAGS_INEXACT | MPFR_FLAGS_ERANGE | MPFR_FLAGS_DIVBY0)
...
__MPFR_DECLSPEC void mpfr_inits2(mpfr_prec_t, mpfr_ptr,
...
__MPFR_DECLSPEC int mpfr_acosu(mpfr_ptr, mpfr_srcptr, unsigned long,
                               mpfr_rnd_t);
__MPFR_DECLSPEC int mpfr_asinu(mpfr_ptr, mpfr_srcptr, unsigned long,
                               mpfr_rnd_t);
__MPFR_DECLSPEC int mpfr_atanu(mpfr_ptr, mpfr_srcptr, unsigned long,
                               mpfr_rnd_t);
__MPFR_DECLSPEC int mpfr_atan2u(mpfr_ptr, mpfr_srcptr, mpfr_srcptr,
...
__MPFR_DECLSPEC int mpfr_atan2pi(mpfr_ptr, mpfr_srcptr, mpfr_srcptr,
                                 mpfr_rnd_t);
...
#define mpfr_custom_get_size(p)                                                \
  ((mpfr_size_t)((mpfr_size_t)(((mpfr_prec_t)(p) + GMP_NUMB_BITS - 1) /        \
                               GMP_NUMB_BITS) *                                \
                 sizeof(mp_limb_t)))
...
*/
    ...
    defined(_STDINT) || defined(_SYS_STDINT_H_) /* needed for FreeBSD */
